...
const RestaurantTemplate = (props: Props) => {
          ...
          <div>
            ...
            <Column gap={6}>
              <Column className="">
                ...
                <Row gap={4}>
                  <Text value={"Email"} className="font-bold" />
                  <Text value={restaurantData.email as string | number} />
                </Row>
                <Row gap={4}>
                  <Text value={"Website"} className="font-bold" />
                  <Text value={restaurantData.website as string | number} />
                </Row>
              </Column>
              <Column>
